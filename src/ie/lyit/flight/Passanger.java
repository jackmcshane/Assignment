...
public class Passanger extends Person{ //INHERITANCE-Passenger IS-A Person
	...
	public Passanger(String t, String fN, String sn, int d, int m, int y, int noB, boolean pB){
