...
//All classes must be Serializable or it won't work
//as the date class is used for birthDate and startDate
public class Date implements Serializable { 
	...
	// Initialisation Constructor
	//throwing an exception if not a number 
   ...
   public boolean equals(Object o){
	...
	public void setDay(int setDayTo) throws IllegalArgumentException{
		if(setDayTo > 31)
		     throw new IllegalArgumentException("Days up to 31");
		//if passed......
	    day=setDayTo;
	}
 	public void setMonth(int setMonthTo) throws IllegalArgumentException {
 		if(setMonthTo > 12)
 			throw new IllegalArgumentException("Month non-existent, must be below 12");
 		//if passed......
 		month = setMonthTo;
 	}
 	public void setYear(int setYearTo) throws IllegalArgumentException{
 		if(setYearTo < 1900)
 			throw new IllegalArgumentException("Must be above year 1900");
 		//if passed......
 		year = setYearTo;
 	}
 }
